...
const Food = () => {
  ...
  // Fliter Types Burgers/pizza/ect
  const fliterTypes = category => {
    setFoods(
      data.filter(item => {
    ...
    <div className="max-w-[1640px] m-auto px-4 py-12">
      ...
      <div className="flex flex-col lg:flex-row justify-between">
        ...
        <div className="flex justify-between flex-wrap">
          ...
          <button
            onClick={() => fliterTypes("burger")}
            className="m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white"
          >
            Burgers
          </button>
          <button
            onClick={() => fliterTypes("pizza")}
            className="m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white"
          >
            Pizza
          </button>
          <button
            onClick={() => fliterTypes("salad")}
            className="m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white"
          >
            Salad
          </button>
          <button
            onClick={() => fliterTypes("chicken")}
            className="m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white"
          >
            Chicken
          </button>
